...
class Session:
    ...
    def __init__(
        ...
        possible_errors = []
        for i in range(400, 600):  # список, содержащий наиболее частые ошибки. они приведут к повторному выполнению запроса
        ...
        http_adapter = HTTPAdapter(max_retries=retry_options)
